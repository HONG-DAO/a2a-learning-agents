...
from agents.a2a_planning_study.host_agent.routing_agent import (
...
async def main():
    ...
    with gr.Blocks(
        theme=gr.themes.Ocean(), title='A2A'
    ) as demo:
        gr.Image(
            'static/a2a.png',
            width=100,
        ...
        gr.ChatInterface(
            ...
            title='A2A',  # Title can be handled by Markdown above
            description='This A2A system has two agents: one designs a personalized study plan, the other generates tailored practice exercises.',
        )
